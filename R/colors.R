...
#'
#' @param n Number of colors to be produced. If > 9, an equally distributed
#'   color ramp will be produced (and probably look bad).
#' @param shade Integer shade level. One of `200`, `300`, `400`, or `600`.
#'
...
flexoki_palette <- function(n, shade = 400) {
  ...
  if (n <= length(base)) {
    ...
    grDevices::colorRampPalette(base, space = "Lab")(n)
  }
}
